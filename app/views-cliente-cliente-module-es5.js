  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-cliente-cliente-module"], {
    ...
    function OAo(module, __webpack_exports__, __webpack_require__) {
      ...
      var ClienteComponent = /*#__PURE__*/function () {
        function ClienteComponent(ApiService, toastr) {
        ...
        _createClass(ClienteComponent, [{
          ...
          value: function excluir(id) {
            ...
            this.carregando = true;
            this.ApiService.delCliente(id).subscribe(function (returno) {
              _this2.toastr.success("Cliente Deletado com sucesso", "Cliente");
          ...
          value: function update(id) {
            ...
            this.cliente.forEach(function (pro) {
              if (pro.id == id) {
                _this3.parametro.id = pro.id;
                _this3.parametro.name = pro.name;
                _this3.parametro.data = pro.categoria;
              }
            });
          ...
          value: function updateCliente() {
            ...
            this.ApiService.updateCliente(this.parametro).subscribe(function (retorno) {
              if (retorno.error) {
              ...
              _this4.toastr.success("Cliente Alterado com sucesso", 'Sucesso!!');
          ...
          value: function criarModal() {
            ...
            this.upcarregando = true;
            this.ApiService.addCliente(this.parametroCriar).subscribe(function (retorno) {
              if (retorno.error) {
              ...
              _this5.toastr.success("Cliente Criado com sucesso", 'Sucesso!!');
      ...
      ClienteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        template: _raw_loader_cliente_component_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_service_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]])], ClienteComponent);
      /***/
    },
    ...
    /***/
    function WRB7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _cliente_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./cliente.component */
      "/OAo");
      ...
      ClienteRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    function iIRT(module, __webpack_exports__, __webpack_require__) {
      ...
      var _cliente_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./cliente.component */
      "/OAo");
      /* harmony import */


      var _cliente_routing_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      ClienteModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_ngneat_content_loader__WEBPACK_IMPORTED_MODULE_9__["ContentLoaderModule"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _cliente_routing_module__WEBPACK_IMPORTED_MODULE_8__["ClienteRoutingModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_3__["ChartsModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_4__["BsDropdownModule"], ngx_bootstrap_buttons__WEBPACK_IMPORTED_MODULE_5__["ButtonsModule"].forRoot(), ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_10__["ModalModule"].forRoot()],
    ...
    /***/
    function tz8v(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=views-cliente-cliente-module-es5.js.map